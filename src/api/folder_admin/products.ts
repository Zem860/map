...
type createProductFunc = (
  params: CreateProductParams
) => Promise<AxiosResponse<MesssageResponse>>;
export const createProduct: createProductFunc = (params) =>
  baseApi.post(`/admin/product`, { data: params });
...
export const deleteProduct: deleteProductFunc = (id: string) =>
  baseApi.delete(`/admin/product/${id}`);
