...
type createCouponFunc = (
  params: couponData
) => Promise<AxiosResponse<MesssageResponse>>;
export const createCoupon: createCouponFunc = (params: couponData) =>
  baseApi.post('/admin/coupon', { data: params });
