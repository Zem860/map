                    ...
                    <div className="container mx-auto px-4 py-8 lg:py-12">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            {!orderNum ?
                                ...
                                :
                                <Link className="w-full md:w-auto md:px-12 py-4 bg-primary text-primary-foreground font-bold rounded-lg shadow-lg hover:brightness-95 active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-lg" to="/">Back to Homepage</Link>
                            }
                        </div>
                    </div>
                </div>}
