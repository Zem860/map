      ...
      <article className="mx-auto max-w-2xl px-6 py-20 md:py-32 space-y-28">
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
            <p>
              In an increasingly digital world, we remain devoted to the
              tactile—the weight of a hardcover, the scent of fresh ink, and the
              quiet intimacy of a well-worn page.
            </p>
            <p>
              <strong className="text-foreground font-semibold">Books</strong>{' '}
              was founded on a singular, powerful idea: that the distance
              between a reader and a great book should never be measured by the
              cost of shipping.
            </p>
          </div>
        </section>
        ...
        <section className="relative py-12 px-8 bg-muted/40 rounded-2xl border-l-4 border-primary">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              When <span className="italic">Book Depository</span> closed its
              doors in 2023, the global community of readers lost more than just
              a bookstore—they lost a bridge.
            </p>
            <p>
              We remember that iconic teal package and the promise it held.
              Books was born to carry that torch forward, ensuring that readers
              in Taipei, Tokyo, London, or beyond still have a home.
            </p>
        ...
        <section className="space-y-12">
          ...
          <div className="grid gap-12">
            <div className="flex gap-8">
              <span className="font-serif text-5xl text-primary/20 select-none">
                01
              </span>
              <div>
                ...
                <p className="text-muted-foreground">
                  No minimum spend, no hidden fees, and no exceptions. One book
                  or twenty, the shipping is on us.
                </p>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  From global bestsellers to obscure indie gems, we source from
                  publishers worldwide to bring the world’s library to your
                  doorstep.
                </p>
              </div>
            </div>
        ...
        <section className="pt-20 text-center space-y-10 border-t border-border">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Explore over a million titles waiting to be discovered.
            </p>
          </div>
          <Link
            to="/"
