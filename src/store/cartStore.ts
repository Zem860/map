...
export const useCartStore = create<CartStore>((set, get) => ({
  ...
  isLoading: false,
  stepperContent: [
    { title: 'Shopping Cart', description: 'Review your selected items' },
    {
      title: 'Shipping Details',
      description: 'Provide your shipping information',
    },
    { title: 'Payment Confirm', description: 'Confirm your payment details' },
  ],
